                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row justify-content-center no-gutters">
                            ...
                            <div class="col-md-6">
                                ...
                                {!! Form::open(['class'=>'form-signin','route'=>'admin.login.otp.verify']) !!}

                                <h2 class="text-dark mb-4 pb-3 text-center d-none d-md-block">Otp Verify</h2>
                                @php
                                    $mobile=Crypt::decryptString($otp_data['mobile']);
                                @endphp
                                <p class="text-dark mb-3">Please Vetrify your account and otp send your registred mobile No.
                                    {{substr($mobile, 0, 2) . "******" . substr($mobile, 8, 2)}}
                                </p>
                                ...
                                <input type="hidden" name="random_id" value="{{$otp_data['id']}}">
                                <input type="hidden" name="random_mobile" value="{{$otp_data['mobile']}}">
                                <input type="hidden" name="cid" value="{{$otp_data['cid']}}">
                                <div class="form-group">

                                    <i class="fa fa-user"></i>

                                    {!! Form::text('otp', '', ['class'=>'form-control', 'placeholder'=>'Otp', 'autofocus']) !!}
                                ...
                                <div class="text-center">
                                    ...
                                    <button type="submit" class="btn btn-lg btn-primary btn-round">Verify</button>
