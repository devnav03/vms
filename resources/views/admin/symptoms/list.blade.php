...
@section('title','Admin :: Covid Questionnaire List')
@section('head')
<div class="page-head">
    <div class="row">
        <div class="col-md-4">
            <h3 class="m-b-less">Covid Questionnaire List</h3>
        </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Covid Questionnaire List</h5>
                <ol class="breadcrumb">
                  <li><a href="{{ route('admin.dashboard.index') }}">Dashboard</a>
                  </li>
                  <li><a>Covid Questionnaire</a>
                  </li>
                </ol>
              </div>
            </div>
            ...
            <table class="display dataTableAjax user-list-table" id="data-table-simple_wrapper" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$menuKey+1}}</td>
                        @if($menuValue->id ==11)                        
                        <td>Boby Tempreture Limit:  {{ $menuValue->name }}</td>
                        @else
