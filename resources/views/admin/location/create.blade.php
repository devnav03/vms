      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col s12 m12 l12">
            ...
            <h5 class="breadcrumbs-title">Add Location</h5>
                ...
                <div class="panel panel-primary">
					<div class="panel-body">
                        ...
                        <div class="col-md-12">
							...
							<h5 class="text-center mt-2rem mb-4"><span>Enter Specific Location</span></h5>
							<div class="form-group">
								<div class="input-outer">
									<small><i class="fa fa-map-marker" aria-hidden="true"></i></small>
									<input type="text" id="pac-input" name="location" required class="form-control" placeholder="Enter a City of Locality">
								</div>
							</div>
