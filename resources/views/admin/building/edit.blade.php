...
@section('title','Admin :: Edit Building')
...
<section class="wrapper main-wrapper">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col s12 m12 l12">
            ...
            <h5 class="breadcrumbs-title">Edit Building</h5>
    ...
    {!! Form::open(['route'=>['admin.'.request()->segment(2).'.update', @$building->id], 'method'=>'put','id'=>'menuForm','class'=>'col s12']) !!}
		...
		<div class="form-group" style="padding: 20px;">
			<div>
				...
				<select name="status_id" id="status_id" class="form-control nowarn" required>
					...
					<option value="0" {{$building->status == 0 ? 'selected':''}}>DeActive</option>
