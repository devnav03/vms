        ...
        <table class="display dataTableAjax user-list-table" id="data-table-simple_wrapper" width="100%">
            <thead>
                <tr>
                    ...
                    <th style="padding-right: 0px;">Officer Name</th>
                    <th style="padding-right: 0px;">Visit Date & Time</th>
            ...
            <tbody>
                @foreach($all_reports as $key => $report)
                    <tr>
                        <td>{{$key+1}}</td>
                        <td>{{$report->refer_code}}</td>
                        <td>{{$report->name}}</td>
                        <td>{{$report->email}}</td>
                        <td>{{$report->mobile}}</td>
                        <td>{{$report->OfficerDetail->name}}</td>
                        <td>{{$report->visite_time}}</td>
                        <td><a href="{{route('admin.repeat.visitor.details',$report->mobile)}}">Check Details</a></td>
