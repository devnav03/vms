    ...
    <nav class="navbar navbar-inverse">
      <div class="container-fluid">
        ...
        <div id="content" align="center">
            {{Form::open(['route'=>['web.check.visitor'],  'method' => 'post', 'enctype'=>'multipart/form-data'])}}
              ...
              <div class="heading_dtl">
                ...
                <div class="login-box col-md-6 col-sm-12 col-xs-12">
                    <div>
                        ...
                        <input placeholder="Enter your register mobile number" type="text" id="mobile" name="mobile" size="30" value="{{old('mobile')}}" class="form-control nowarn" maxlength="10">
                    </div>
                </div>
                <div class="login-box col-md-6 col-sm-12 col-xs-12">
          ...
          <div class="row">
            <div id="otp_check">
                ...
                <p>Please verify your otp to process re visit application.</p>
