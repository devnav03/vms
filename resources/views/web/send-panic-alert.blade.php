    ...
    <div id="content">      
        <div id="otp_check">
            ...
            <div class="login-box col-md-6 col-sm-12 col-xs-12">
                ...
                <a href="{{route('visitor.panic.alert').'/'.$encrypted.'/'.@$officer_ids}}" class="btn btn-success" style="padding: 6px 8px;font-size: 36px;font-weight: 600;width: 200px;">Yes</a><br/>
