...
<nav class="navbar navbar-inverse">
  ...
  <div class="row" style="margin-top:40px;" id="reg">
    <div style="text-align: right; padding: 0px 20px 0px 0px; margin-top: 26px; font-size: 16px;">
      <span><b>Pre-Invitations Registration</b></span>
      <p style="font-size: 12px;">Please fill the below details</p>
  </div>
    <div id="loader-p">
    </div>
    {{Form::open(['route'=>['add.pre-visit-registration'],  'method' => 'post', 'enctype'=>'multipart/form-data'])}}
						...
						<div  id="camera_document_mode_div">
								<div class="login-box col-md-6 col-sm-6 col-xs-12">
									<div class="login-box">
										...
										<input type="hidden" name="attachmant_img" value="{{old('attachmant')}}" class="image-tag_document">
										@if($errors->has('attachmant'))
										<p class="text-danger">{{ $errors->first('attachmant') }}</p>
										@endif
									<div id="results_document" style="color:#107cab; font-size: 14px;margin-top: 13px;"><!--Your captured document image will appear here... --></div>
									</div>
								</div>
						</div>
            ...
            <div class="row">
              ...
              <div class="login-box col-md-4 col-sm-12 col-xs-12">
                  <div>
                      ...
                      <input type="datetime-local" name="visite_time" size="30" value="{{@$datas->pre_visit_date_time}}" class="form-control nowarn" required readonly>
            ...
            <div class="row">
              <div class="login-box col-md-4 col-sm-12 col-xs-12">
                ...
                <select name="location_id" id="location_id" class="form-control nowarn" required>
                  <option value="{{@$datas->location->id}}" selected>{{@$datas->location->name}}</option> 
                </select>
              ...
              <div  class="login-box col-md-4 col-sm-12 col-xs-12">
                ...
                <select name="building_id" id="building_id" class="form-control nowarn" required style="display:block;">
                  <option value="{{@$datas->building->id}}" selected>{{@$datas->building->name}}</option>
                </select>
              </div>
              <div class="login-box col-md-4 col-sm-12 col-xs-12">
              <label for="department_id">Select :<span class="text-danger">*</span> </label>
                <select name="department_id" id="department_id" class="form-control nowarn" required style="display:block;">
                  <option value="{{@$datas->OfficerDepartment->id}}" selected>{{@$datas->OfficerDepartment->name}}</option>
                </select>
              </div>
            </div>
            <div class="row">
              <div class="login-box col-md-4 col-sm-12 col-xs-12">
                     ...
                     <select name="officer" id="officer_id" class="form-control nowarn" required>
                       <option value="{{@$datas->OfficerDetail->id}}" selected>{{@$datas->OfficerDetail->name}}</option>
                     </select>
          ...
          <div class="row">
            <div class="login-box hide_in_phone col-md-4 col-sm-12 col-xs-12">
	     ...
	     <input type="hidden" name="image_mode" value="folder">		  
          <div class="col-md-8 col-sm-12 col-xs-12" id="camera_mode_div">
			<div class="row">  
            <div class="col-md-6 col-sm-12 col-xs-12">
			 ...
			 <div class="col-md-6 col-sm-12 col-xs-12">
              <div class="login-box" style="width: 100%;">
                  <div id="results" style="border: 0px; background: transparent;"><!--Captured photo image will appear here... --></div>
              </div>
              </div>
			  </div>
			 </div>
