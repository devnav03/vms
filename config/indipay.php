...
return [
    ...
    */
    ...
    'ccavenue' => [                         // CCAvenue Parameters
        'merchantId'  => env('INDIPAY_MERCHANT_ID', '241336'),
        'accessCode'  => env('INDIPAY_ACCESS_CODE', 'AVMI03GL01BL00IMLB'),
        'workingKey' => env('INDIPAY_WORKING_KEY', 'C6B5FD90F688DE972C9A3213C8D46421'),
