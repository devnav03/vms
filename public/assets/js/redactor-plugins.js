...
(function($R) {
    ...
    $R.add('plugin', 'imageannotate', {
        ...
        modals: {
            'annotate': '<div class="toolbar" style="margin-top:-24px;margin-bottom:10px"></div>' +
        ...
        teardownAnnotate: function() {
            var state = this.canvas.toObject(),
                places = 2;
        ...
        drawArrow: function() {
            ...
            return this.drawShape(
                ...
                function(shape, pointer) {
                    ...
                    shape.forEachObject(function(e) {
                        shape.removeWithUpdate(e);
                    });
    ...
    $R.add('plugin', 'contexttypeahead', {
        ...
        watch: function(e) {
            ...
            if (position) {
                ...
                this.typeahead
                    .css({
                        top: position.top + this.app.$win.scrollTop(),
                        left: left
                    });
            }
